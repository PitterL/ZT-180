...
static int __init imapx200_init(void)
{
	...
	if (gpio_request(IMAPX200_GPO(2), "power on"))
		return 0;
	if (gpio_request(IMAPX200_GPL(9), "speak on"))
		return 0;		
	gpio_direction_output(IMAPX200_GPO(2),1);
	gpio_direction_output(IMAPX200_GPL(9),1);
