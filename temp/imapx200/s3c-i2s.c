...
static u32 iiscon_pm;
static u32 iismod_pm;
static u32 iisfcon_pm;
static u32 iispsr_pm;
static u32 iisfic_pm;
...
static struct s3c24xx_pcm_dma_params s3c24xx_i2s_pcm_stereo_out = {
	...
	.dma_size	= 2,
#else
	.dma_addr	= S3C64XX_PA_IIS0 + S3C2410_IISFIFO,
	.dma_size	= 4,
#endif
};
...
static struct s3c24xx_pcm_dma_params s3c24xx_i2s_pcm_stereo_in = {
	...
	.dma_size	= 2,
#else
	.dma_addr	= S3C64XX_PA_IIS0 + S3C2410_IISFIFORX,
	.dma_size	= 4,
#endif
};
				...
				struct snd_pcm_hw_params *params)
{
	...
	s3c_gpio_setpull(S3C64XX_GPD(0), 0x2);
	s3c_gpio_setpull(S3C64XX_GPD(1), 0x2);
	s3c_gpio_setpull(S3C64XX_GPD(2), 0x2);
	s3c_gpio_setpull(S3C64XX_GPD(3), 0x2);
	s3c_gpio_setpull(S3C64XX_GPD(4), 0x2);
...
static int s3c_i2s_probe(struct platform_device *pdev)
{
	...
	{
		printk(KERN_INFO "regs is null, exit!\n");
		return -ENXIO;
	}
#if !defined (CONFIG_CPU_S3C6400) && !defined (CONFIG_CPU_S3C6410)
	...
	/* Configure the I2S pins in correct mode */
	s3c_gpio_cfgpin(S3C64XX_GPD2,S3C64XX_GPD2_I2S_LRCLK0);

	s3c_gpio_cfgpin(S3C64XX_GPD0,S3C64XX_GPD0_I2S_CLK0);
		
	s3c_gpio_cfgpin(S3C64XX_GPD1,S3C64XX_GPD1_I2S_CDCLK0);
	s3c_gpio_cfgpin(S3C64XX_GPD3,S3C64XX_GPD3_I2S_DI0);
	s3c_gpio_cfgpin(S3C64XX_GPD4,S3C64XX_GPD4_I2S_DO0);

	/* pull-up-enable, pull-down-disable*/
	s3c_gpio_setpull(S3C64XX_GPD0, 0x2);
	s3c_gpio_setpull(S3C64XX_GPD1, 0x2);
	s3c_gpio_setpull(S3C64XX_GPD2, 0x2);
	s3c_gpio_setpull(S3C64XX_GPD3, 0x2);
	s3c_gpio_setpull(S3C64XX_GPD4, 0x2);
	...
	struct snd_soc_cpu_dai *dai)
{
	s3cdbg("Entered %s\n", __FUNCTION__);
	printk(KERN_INFO "%x\n",s3c24xx_i2s.regs);
	iiscon_pm = readl(s3c24xx_i2s.regs + S3C2410_IISCON);
	iismod_pm = readl(s3c24xx_i2s.regs + S3C2410_IISMOD);
	iisfcon_pm = readl(s3c24xx_i2s.regs + S3C2410_IISFCON);
	iispsr_pm = readl(s3c24xx_i2s.regs + S3C2410_IISPSR);
	...
	struct snd_soc_cpu_dai *dai)
{
	...
	writel(iiscon_pm, s3c24xx_i2s.regs + S3C2410_IISCON);
	writel(iismod_pm, s3c24xx_i2s.regs + S3C2410_IISMOD);
	writel(iisfcon_pm, s3c24xx_i2s.regs + S3C2410_IISFCON);
	writel(iispsr_pm, s3c24xx_i2s.regs + S3C2410_IISPSR);

	iismod_pm = readl(s3c24xx_i2s.regs + S3C2410_IISMOD);
	iismod_pm |= S3C_IIS0MOD_TXMODE;
	writel(iismod_pm,s3c24xx_i2s.regs + S3C2410_IISMOD);
	...
	iispsr_pm = readl(s3c24xx_i2s.regs + S3C2410_IISPSR);
	iisfic_pm = readl(s3c24xx_i2s.regs + S3C2443_IISFIC);
	writel(iisfic_pm |(1<<15), s3c24xx_i2s.regs + S3C2443_IISFIC);
	iisfic_pm = readl(s3c24xx_i2s.regs + S3C2443_IISFIC);
	writel(iisfic_pm | (~(1<<15)), s3c24xx_i2s.regs + S3C2443_IISFIC);
	iisfic_pm = readl(s3c24xx_i2s.regs + S3C2443_IISFIC);
	return 0;
...
{
	return 0;
//return snd_soc_register_dais(s3c_i2s_dai,ARRAY_SIZE(s3c_i2s_dai));
}
...
{
	snd_soc_unregister_dais(s3c_i2s_dai,
				ARRAY_SIZE(s3c_i2s_dai));
}
