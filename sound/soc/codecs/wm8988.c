...
static int wm8988_add_i2c_device(struct platform_device *pdev,
				 const struct wm8987_setup_data *setup)
{
	...
	printk("wm8988_add_i2c_device setup->i2c_bus = 0x%x, setup->i2c_address = 0x%x\r\n"
	...
	printk("wm8988_add_i2c_device 2\r\n");
	client = i2c_new_device(adapter, &info);
	printk("wm8988_add_i2c_device 3\r\n");
	...
	printk("wm8988_add_i2c_device 4\r\n");
