...
static int mmc_decode_csd(struct mmc_card *card)
{
	...
	// Added by yqcui 2010-7-22
	csd->mmca_vsn = csd_struct;
	printk("mmc_decode_csd : csd_struct = %d\r\n",csd_struct);
...
static int mmc_switch_hs(struct mmc_card *card)
{
	...
	// Added by yqcui 2010-7-22
	if( 0 == card->csd.mmca_vsn ) {
		printk("mmc_switch_hs : low card , capacity = %d\r\n",card->csd.capacity);
		return 0;
	}
	...
	if ((status[16] & 0xF) != 1) {
		...
		printk("mmc_switch_hs mmc_card_set_highspeed\r\n");
